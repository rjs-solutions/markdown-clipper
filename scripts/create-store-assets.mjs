...
const shots = [
  ...
  { raw: "03-collection-export-raw.png", output: "03-collection-export-1280x800.png", headline: "Export a URL list, sitemap, llms.txt, or whole site", body: "Build a structured Markdown snapshot from the sources you already maintain.", chips: ["TXT, CSV, XLSX", "Sitemaps", "ZIP + index.md"] },
...
await saveSvg(promoSvg(icon, 1400, 560, "Capture the web as clean, portable Markdown", "Clip one page or export a collection—private, local, and ready for your knowledge workflow."), 1400, path.join(promoDir, "marquee-promo-tile-1400x560.png"));

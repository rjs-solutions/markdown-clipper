...
const shots = [
  ...
  { raw: "02-collections-raw.png", output: "02-collections-1280x800.png", headline: "Keep important sites organized as reusable collections", body: "Save inventories, refresh for changes, and give every collection its own local folder.", chips: ["Saved collections", "Change detection", "Local library"], crop: "xMidYMax" },
  { raw: "03-collection-capture-raw.png", output: "03-collection-capture-1280x800.png", headline: "Capture pages from a list, sitemap, llms.txt, or whole site", body: "Bring related pages together, then save, sync, or export Markdown without extra cleanup.", chips: ["TXT, CSV, XLSX", "Sitemaps", "Markdown or ZIP"] },

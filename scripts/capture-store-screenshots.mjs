...
try {
  ...
  await capture(crawl, "03-collection-export-raw.png");
  ...
  await fs.writeFile(reportPath, `${JSON.stringify({ version, startedAt, completedAt: new Date().toISOString(), viewport: { width: 1280, height: 800 }, source: "sanitized local demo", files: ["01-capture-raw.png", "02-collections-raw.png", "03-collection-export-raw.png", "04-knowledge-base-raw.png", "05-editor-raw.png"] }, null, 2)}\n`);

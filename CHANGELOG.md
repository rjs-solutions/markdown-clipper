...
- Turn Capture Collection's disabled Export Markdown action into a determinate progress bar with
  ...
  automatically reveal the expanded detailed progress stream once when a job begins or resumes.
- Generalize saved SharePoint sites into **Collections** for SharePoint, Confluence, websites,
  ...
  discovery modes.
- Add TXT, CSV, and XLSX URL-list import to Capture Collection, plus per-collection and all-
  collections CSV inventory export.
- Redesign Capture Collection with branded, collapsible sections and open it beside the in-page
...
- Name the workflow Capture Collection and bring it into the main visual system with a compact branded header, flat
